...
- [x] Look into ways to properly identify the points on the roof edges
- [ ] Use the alignment of the point with the previous points to determine how certain it is that the point is a roof edge.
- [x] Ask Wu Teng about sensor topology (regular 2D structure on a point cloud based on acquisition regularity).
