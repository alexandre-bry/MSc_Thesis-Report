    ...
    config-methods(
      init: (self: none, body) => {
        ...
        show heading.where(level: 3): set text(
          size: size-slide-subtitle,
          weight: "semibold",
          fill: c.text-primary,
          tracking: tracking-tight,
        )
        show heading.where(level: 4): set text(
          size: size-slide-subsubtitle,
          weight: "semibold",
          fill: c.text-primary,
          tracking: tracking-tight,
        )
        ...
        // Figure captions
        show figure.caption: set text(size: size-caption)
...
// #let warm-amber-theme = ign-theme
// #let thesis-theme = ign-theme

// // Convenience function to create a presentation with specific settings
// #let moloch-style-theme = ign-theme.with(
//   header-style: "moloch",
//   progressbar: "foot",
//   title-layout: "moloch",
// )

// #let minimal-style-theme = ign-theme.with(
//   header-style: "minimal",
//   progressbar: "foot",
//   title-layout: "centered",
// )

// #let dark-theme = ign-theme.with(
//   variant: "dark",
// )
