...
#show: slides-theme.with(
  config-info(
    ...
    subtitle: [Monthly Presentation (4)],
...
We use the *height differences* between neighbour points on the same scan line and on consecutive scan lines to identify points that are likely to be on the edges of roofs.
